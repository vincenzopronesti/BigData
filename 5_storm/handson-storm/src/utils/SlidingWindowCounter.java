 ...
 * counts of objects, and 2) to give a single "consumer" thread (e.g. PeriodicSlidingWindowCounter) read access
 ...
 *
 * Read more on: http://www.michael-noll.com/blog/2013/01/18/implementing-real-time-trending-topics-in-storm/
 */
public final class SlidingWindowCounter<T> implements Serializable {
    ...
    public Map<T, Long> getCountsThenAdvanceWindow() {
        ...
        advanceHead();  // move the window forward
        return counts;
    }
